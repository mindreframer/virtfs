defmodule Virtfs.GlobMatcher do
  @moduledoc false
  ...
  def match?(subject, pattern, opts) when is_binary(pattern) do
    mode = Keyword.get(opts, :mode, :codepoint)
  ...
  def match?(subject, regex, _opts) when is_struct(regex, Regex) do
    Regex.match?(regex, subject)
  end

  # Public for testing
  def compile_pattern(pattern, mode \\ :codepoint) do
    # Escaped
